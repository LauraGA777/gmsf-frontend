...
// GET /api/schedules/availability - Check schedule availability (debe ir antes que /:id)
...
// GET /api/schedules/daily/:date - Get daily schedule
...
// GET /api/schedules/monthly - Get monthly schedule
router.get("/monthly", 
    verifyToken as unknown as RequestHandler,
