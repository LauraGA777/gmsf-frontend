...
export function SchedulePage() {
    ...
    useEffect(() => {
        ...
        } else if (user?.role === "ADMIN" || user?.role === "ENTRENADOR") {
    ...
    const checkMembership = (user: UserType) => {
        ...
        if (!hasActive && user.role === "CLIENTE") {
            Swal.fire({
    ...
    const handleAddTraining = () => {
        ...
        if (user?.role === "CLIENTE" && !hasActiveMembership) {
            Swal.fire({
                title: "Contrato inactivo",
    ...
    const handleAddTrainingSubmit = (newTraining: Omit<Training, "id">) => {
        ...
        const trainingToAdd: Training = {
            ...newTraining,
            id,
            clientId: user?.role === "CLIENTE" ? user.clientId : newTraining.clientId,
            trainerId: user?.role === "ENTRENADOR" ? user.trainerId : newTraining.trainerId,
